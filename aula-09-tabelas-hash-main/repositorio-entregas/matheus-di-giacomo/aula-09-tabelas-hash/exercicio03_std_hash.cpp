...
int main() {
    ...
    // 4. Houve colisoes no seu computador? Resposta variavel conforme a execucao.
    // 5. Compare com um colega: os indices deram iguais? Por que? Os indices podem variar porque a implementacao do std::hash para strings nao e padronizada pela norma do C++, podendo mudar entre diferentes compiladores, bibliotecas padrao (como libstdc++ vs libc++) ou arquiteturas de sistema.
